...
<body>
    ...
    <div id="getEmployees">
        <form:form action="http://localhost:8585/oauth/authorize"
            method="post" modelAttribute="emp">
            <p>
                <label>Enter Employee Id</label>
                 <input type="text" name="response_type" value="code" /> 
                 <input type="text" name="client_id" value="taruntest" />
                 <input type="text" name="redirect_uri" value="http://localhost:8586/showEmployees" />
